...
describe('FollowButton', () => {
  ...
  describe('follow actions', () => {
    ...
    it('updates to "following" state after successful follow', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByRole('button', { name: /Following|Unfollow/ })).toBeInTheDocument()
      })
    })
  ...
  describe('error handling', () => {
    it('shows error message when mutation fails', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByRole('button', { name: 'Failed. Try again.' })).toBeInTheDocument()
      })
    })
  ...
  describe('state sync with initialState prop', () => {
    it('updates when initialState prop changes', () => {
      const { rerender } = renderFollowButton({ initialState: 'not_following' })
      expect(screen.getByRole('button', { name: 'Follow' })).toBeInTheDocument()
