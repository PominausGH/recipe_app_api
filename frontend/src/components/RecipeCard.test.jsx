...
describe('RecipeCard', () => {
  describe('basic rendering', () => {
    ...
    it('links to recipe detail page', () => {
      ...
      const cardLink = links.find(link => link.getAttribute('href') === '/recipes/1')
  ...
  describe('rating display', () => {
    ...
    it('shows "N/A" when no average rating', () => {
      const unratedRecipe = { ...mockRecipe, average_rating: null, rating_count: 0 }
      renderRecipeCard(unratedRecipe)
      expect(screen.getByText('N/A')).toBeInTheDocument()
    })

    it('does not show rating count when zero', () => {
      const unratedRecipe = { ...mockRecipe, average_rating: 3.0, rating_count: 0 }
      renderRecipeCard(unratedRecipe)
